...
&kp LBKT,          &kp N7,            &kp N8,            &kp N9,            &kp RBKT,          &kp ASTERISK,      &kp SLASH,         &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
&kp SEMI,          &kp N4,            &kp N5,            &kp N6,            &kp EQUAL,         &kp PLUS,          &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,          \
&kp GRAVE,         &kp N1,            &kp N2,            &kp N3,            &kp BSLH,          &kp MINUS,         &u_to_U_NUM,       &u_to_U_NAV,       &kp DOT,           &kp COLON,              \
